...
class ConfigHelper {
  ...
  ConfigHelper(ConfigService service) {
    ...
    _service.Get('backend_scheme')
      .then((value) {
        backendScheme = value;
        _service.Get('backend_base_url').then((value) {
          backendBaseUrl = value;
          _service.Get('backend_port').then((value) {
            backendPort = value;
            backendUrl = '$backendScheme://$backendBaseUrl:$backendPort';
          }).then((value) {

            _service.Get('backend_contracts').then((value) {
              contractsUrl = '$backendUrl/$value';
            });

            _service.Get('backend_logs').then((value) {
